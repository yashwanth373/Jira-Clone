...
const transporter = nodemailer.createTransport({
    ...
    port: 587,
    auth: {
        user: 'jiraclone@gmail.com',
        pass: 'fvzyrddyltmarajd',
    },
});
...
function invite(project_id, project_name, inviter, mails) {
    ...
    const message = "<h2>Hi</h2> <h3>You have been invited to join the project <b>" + project_name + "</b> by " + inviter + "</h3> <h3>Please click on the link below to accept the invitation</h3> <a href='http://localhost:4500/invitation/" + project_id + "'>Accept Invitation</a>";
