...
export class DataService {
  ...
  loginMicrosoft(redirectUrl: any) {
    window.open('/microsoftauth/' + encodeURIComponent(redirectUrl), '_self');
  }

  loginGithub(redirectUrl: any) {
    window.open('/githubauth/' + encodeURIComponent(redirectUrl), '_self');
  }
  ...
  createProject(project_name: any, project_key: any) {
    ...
    return this.http.post('/createProject', {
  ...
  deleteIssue(project_id: any, issue_id: any, sprint_id: any) {
    ...
    return this.http.delete(
      '/deleteIssue/' + project_id + '/' + issue_id + '/' + sprint_id
    );
  }
  ...
  inviteUser(project: any, mails: any) {
    ...
    return this.http.post('/inviteUser', {
      mails: emailsList,
      project: project,
    });
  }
  ...
  // Specific for Invite Component
  acceptInvite(project_id: any,userDetails: any) {
    console.log('accepting invite', project_id,userDetails);
